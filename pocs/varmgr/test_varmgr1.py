...
def sample_datasets():
    ...
    dataset2 = {
        ...
        "options": "value",
        "flags": {"debug": True, "verbose": False, "level": 0},
        "empty_list": [],
        "empty_dict": {},
        "mixed_list": [1, "two", False, None, {"key": "value"}],
        "status": None,
        "counts": {"success": 1, "failure": 0, "skipped": -1},
    }
    dataset3 = {
...
def test_source_order_validation():
    ...
    with pytest.raises(AlreadyExistingSourceError):
        mgr.set_order([Source("same", level=1), Source("same", level=2)])
